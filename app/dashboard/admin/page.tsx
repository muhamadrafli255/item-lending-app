  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button className="inline-flex items-center justify-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl transition-colors shadow-lg shadow-blue-500/20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          { label: "Total Barang", value: "48", icon: "📊", color: "blue" },
          { label: "Request Baru", value: "5", icon: "🔔", color: "rose" },
          { label: "Barang Keluar", value: "18", icon: "📤", color: "indigo" },
          { label: "User Aktif", value: "124", icon: "👥", color: "emerald" },
        ].map((stat) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-[#0f172a] rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
            ...
            <span className="px-2.5 py-0.5 text-xs font-semibold bg-rose-100 text-rose-600 dark:bg-rose-900/20 dark:text-rose-400 rounded-full">5 Baru</span>
          </div>
              ...
              <div key={i} className="p-4 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Meminta Laptop {i}</p>
                  </div>
                </div>
