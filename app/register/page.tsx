...
import { registerSchema, RegisterSchema } from "@/app/_schemas/register-schema"
...
export default function RegisterPage() {
    ...
    const onSubmit = async (data: RegisterSchema) => {
        try {
            ...
            // Send verification email via Resend provider
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-zinc-900 px-4">
            <form
               ...
               dark:border-zinc-700 space-y-5 transition-all"
            >
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-white dark:bg-zinc-800 px-2 text-gray-500">Or sign up with</span>
                    </div>
                </div>
